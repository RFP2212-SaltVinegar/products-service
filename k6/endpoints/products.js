// run k6 run k6/endpoints/products.js
// summary file uploaded at k6/summary/products.html
...
export const options = {
  stages: [
    { duration: '30s', target: 1500 }, // manually ramping the VUs to target of 2200
...
export function handleSummary(data) {
  return {
    "k6/summary/products.html": htmlReport(data)
  }
};
